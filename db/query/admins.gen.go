...
func newAdmin(db *gorm.DB, opts ...gen.DOOption) admin {
	...
	_admin.Level = field.NewInt(tableName, "level")
	_admin.User = adminBelongsToUser{
		...
		Customer: struct {
			...
			RelationField: field.NewRelation("User.Customer", "model.Customer"),
			User: struct {
				field.RelationField
			}{
				RelationField: field.NewRelation("User.Customer.User", "model.User"),
			},
			Orders: struct {
				field.RelationField
				Customer struct {
				...
				RelationField: field.NewRelation("User.Customer.Orders", "model.Order"),
				Customer: struct {
					field.RelationField
				}{
					RelationField: field.NewRelation("User.Customer.Orders.Customer", "model.Customer"),
				},
				OrderItems: struct {
					field.RelationField
					Order struct {
					...
					Product: struct {
						...
						RelationField: field.NewRelation("User.Customer.Orders.OrderItems.Product", "model.Product"),
						Merchant: struct {
							field.RelationField
							User struct {
								field.RelationField
							...
							RelationField: field.NewRelation("User.Customer.Orders.OrderItems.Product.Merchant", "model.Merchant"),
							User: struct {
								field.RelationField
							}{
								RelationField: field.NewRelation("User.Customer.Orders.OrderItems.Product.Merchant.User", "model.User"),
							},
							Products: struct {
								field.RelationField
							}{
								RelationField: field.NewRelation("User.Customer.Orders.OrderItems.Product.Merchant.Products", "model.Product"),
							},
						},
					},
				},
			...
			Cart: struct {
				...
				RelationField: field.NewRelation("User.Customer.Cart", "model.CartItem"),
				Customer: struct {
					field.RelationField
				}{
					RelationField: field.NewRelation("User.Customer.Cart.Customer", "model.Customer"),
				},
				Product: struct {
					field.RelationField
				}{
					RelationField: field.NewRelation("User.Customer.Cart.Product", "model.Product"),
				},
			},
		},
		Merchant: struct {
			...
			RelationField: field.NewRelation("User.Merchant", "model.Merchant"),
		},
		Admin: struct {
			field.RelationField
			User struct {
			...
			RelationField: field.NewRelation("User.Admin", "model.Admin"),
			User: struct {
				field.RelationField
			}{
				RelationField: field.NewRelation("User.Admin.User", "model.User"),
			},
		},
	}
...
type adminBelongsToUser struct {
	db *gorm.DB
...
func (a adminBelongsToUser) Where(conds ...field.Expr) *adminBelongsToUser {
	if len(conds) == 0 {
		return &a
	}
...
func (a adminBelongsToUser) WithContext(ctx context.Context) *adminBelongsToUser {
	a.db = a.db.WithContext(ctx)
	return &a
}

func (a adminBelongsToUser) Session(session *gorm.Session) *adminBelongsToUser {
	a.db = a.db.Session(session)
	return &a
}

func (a adminBelongsToUser) Model(m *model.Admin) *adminBelongsToUserTx {
	return &adminBelongsToUserTx{a.db.Model(m).Association(a.Name())}
}

func (a adminBelongsToUser) Unscoped() *adminBelongsToUser {
	a.db = a.db.Unscoped()
	return &a
}

type adminBelongsToUserTx struct{ tx *gorm.Association }

func (a adminBelongsToUserTx) Find() (result *model.User, err error) {
	return result, a.tx.Find(&result)
}

func (a adminBelongsToUserTx) Append(values ...*model.User) (err error) {
...
func (a adminBelongsToUserTx) Replace(values ...*model.User) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a adminBelongsToUserTx) Delete(values ...*model.User) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a adminBelongsToUserTx) Clear() error {
	return a.tx.Clear()
}

func (a adminBelongsToUserTx) Count() int64 {
	return a.tx.Count()
}

func (a adminBelongsToUserTx) Unscoped() *adminBelongsToUserTx {
	a.tx = a.tx.Unscoped()
	return &a
}
