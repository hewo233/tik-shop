...
func Use(db *gorm.DB, opts ...gen.DOOption) *Query {
	return &Query{
		...
		PaymentDetail: newPaymentDetail(db, opts...),
...
func (q *Query) clone(db *gorm.DB) *Query {
	return &Query{
		...
		PaymentDetail: q.PaymentDetail.clone(db),
...
func (q *Query) ReplaceDB(db *gorm.DB) *Query {
	return &Query{
		...
		PaymentDetail: q.PaymentDetail.replaceDB(db),
...
type queryCtx struct {
	...
	PaymentDetail IPaymentDetailDo
	Product       IProductDo
	User          IUserDo
}
...
func (q *Query) WithContext(ctx context.Context) *queryCtx {
	return &queryCtx{
		...
		PaymentDetail: q.PaymentDetail.WithContext(ctx),
