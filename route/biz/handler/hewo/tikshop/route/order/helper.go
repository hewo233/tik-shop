...
func NormalCustomerChecker[T any](ctx context.Context, c *app.RequestContext, buildResp func(response *base.BaseResponse) T) (id int64, ok bool) {
	...
	if roleCtxStr != consts.RoleCustomer && roleCtxStr != consts.RoleAdmin {
