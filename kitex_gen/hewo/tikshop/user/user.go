...
func (p *AuthRequest) SetUsername(val string) {
	p.Username = val
}
func (p *AuthRequest) SetPassword(val string) {
	p.Password = val
}
...
func (p *AuthRequest) DeepEqual(ano *AuthRequest) bool {
	if p == ano {
		return true
	} else if p == nil || ano == nil {
		return false
...
func (p *AuthRequest) Field1DeepEqual(src string) bool {
...
func (p *AuthRequest) Field2DeepEqual(src string) bool {
...
type UserService interface {
	Auth(ctx context.Context, request *AuthRequest) (r *AuthResponse, err error)

	AdminAuth(ctx context.Context, request *AuthRequest) (r *AuthResponse, err error)
...
type UserServiceAuthArgs struct {
	Request *AuthRequest `thrift:"request,1" frugal:"1,default,AuthRequest" json:"request"`
}
...
var UserServiceAuthArgs_Request_DEFAULT *AuthRequest

func (p *UserServiceAuthArgs) GetRequest() (v *AuthRequest) {
	if !p.IsSetRequest() {
		return UserServiceAuthArgs_Request_DEFAULT
	}
	return p.Request
}
func (p *UserServiceAuthArgs) SetRequest(val *AuthRequest) {
	p.Request = val
}
...
func (p *UserServiceAuthArgs) Field1DeepEqual(src *AuthRequest) bool {
...
type UserServiceAuthResult struct {
	...
	Err     *ErrorResponse `thrift:"err,1,optional" frugal:"1,optional,ErrorResponse" json:"err,omitempty"`
}
...
var UserServiceAuthResult_Success_DEFAULT *AuthResponse

func (p *UserServiceAuthResult) GetSuccess() (v *AuthResponse) {
	if !p.IsSetSuccess() {
...
var UserServiceAuthResult_Err_DEFAULT *ErrorResponse

func (p *UserServiceAuthResult) GetErr() (v *ErrorResponse) {
	if !p.IsSetErr() {
...
func (p *UserServiceAuthResult) SetErr(val *ErrorResponse) {
	p.Err = val
}
...
func (p *UserServiceAuthResult) Field0DeepEqual(src *AuthResponse) bool {
...
func (p *UserServiceAuthResult) Field1DeepEqual(src *ErrorResponse) bool {
...
var UserServiceAdminAuthArgs_Request_DEFAULT *AuthRequest

func (p *UserServiceAdminAuthArgs) GetRequest() (v *AuthRequest) {
	if !p.IsSetRequest() {
		return UserServiceAdminAuthArgs_Request_DEFAULT
	}
	return p.Request
}
func (p *UserServiceAdminAuthArgs) SetRequest(val *AuthRequest) {
	p.Request = val
}
...
func (p *UserServiceAdminAuthArgs) Field1DeepEqual(src *AuthRequest) bool {
...
var UserServiceAdminAuthResult_Success_DEFAULT *AuthResponse

func (p *UserServiceAdminAuthResult) GetSuccess() (v *AuthResponse) {
	if !p.IsSetSuccess() {
...
var UserServiceAdminAuthResult_Err_DEFAULT *ErrorResponse

func (p *UserServiceAdminAuthResult) GetErr() (v *ErrorResponse) {
	if !p.IsSetErr() {
...
func (p *UserServiceAdminAuthResult) SetErr(val *ErrorResponse) {
	p.Err = val
}
...
func (p *UserServiceAdminAuthResult) Field0DeepEqual(src *AuthResponse) bool {
...
func (p *UserServiceAdminAuthResult) Field1DeepEqual(src *ErrorResponse) bool {
...
var UserServiceGetUserInfoResult_Err_DEFAULT *ErrorResponse

func (p *UserServiceGetUserInfoResult) GetErr() (v *ErrorResponse) {
	if !p.IsSetErr() {
...
func (p *UserServiceGetUserInfoResult) SetErr(val *ErrorResponse) {
	p.Err = val
}
...
func (p *UserServiceGetUserInfoResult) Field1DeepEqual(src *ErrorResponse) bool {
...
var UserServiceUpdateUserResult_Err_DEFAULT *ErrorResponse

func (p *UserServiceUpdateUserResult) GetErr() (v *ErrorResponse) {
	if !p.IsSetErr() {
...
func (p *UserServiceUpdateUserResult) SetErr(val *ErrorResponse) {
	p.Err = val
}
...
func (p *UserServiceUpdateUserResult) Field1DeepEqual(src *ErrorResponse) bool {
...
var UserServiceRegisterResult_Err_DEFAULT *ErrorResponse

func (p *UserServiceRegisterResult) GetErr() (v *ErrorResponse) {
	if !p.IsSetErr() {
...
func (p *UserServiceRegisterResult) SetErr(val *ErrorResponse) {
	p.Err = val
}
...
func (p *UserServiceRegisterResult) Field1DeepEqual(src *ErrorResponse) bool {
...
var UserServiceUpdatePasswordResult_Err_DEFAULT *ErrorResponse

func (p *UserServiceUpdatePasswordResult) GetErr() (v *ErrorResponse) {
	if !p.IsSetErr() {
...
func (p *UserServiceUpdatePasswordResult) SetErr(val *ErrorResponse) {
	p.Err = val
}
...
func (p *UserServiceUpdatePasswordResult) Field1DeepEqual(src *ErrorResponse) bool {
